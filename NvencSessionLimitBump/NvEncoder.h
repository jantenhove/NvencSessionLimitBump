...
public:
    ...
    */
    void EncodeFrame(std::vector<NvEncOutputFrame> &vPacket, NV_ENC_PIC_PARAMS *pPicParams = nullptr);
    ...
    *  an encoder session.
    */
    void EndEncode(std::vector<NvEncOutputFrame> &vPacket);
    ...
    */
	...
	NV_ENCODE_API_FUNCTION_LIST GetFunctionList() const { return m_nvenc; }
...
private:
    ...
    */
    void DoEncode(NV_ENC_INPUT_PTR inputBuffer, std::vector<NvEncOutputFrame> &vPacket, NV_ENC_PIC_PARAMS *pPicParams);
